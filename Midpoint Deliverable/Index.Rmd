...
## Introduction
Climate change is a really relevant topic today and is a problem that needs to be solved. It’s also a global crisis that a lot of countries are facing. It is important to understand what are the factors that are contributing to global warming, as well as its impact on the world. This document summarizes how countries are impacted by climate change as well as the ways in which these countries are contributing to climate change. 
