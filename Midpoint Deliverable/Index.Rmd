...
## Introduction
Climate change is a really relevant topic today and is a problem that needs to be solved. It’s also a global crisis that a lot of countries are facing. It is important to understand what are the factors that are contributing to global warming, as well as its impact on the world. This document summarizes how countries are impacted by climate change. We are specifically interested in how the factor of waste production contributes to global warming in differnt countries. To help global warming, recycling plays a big role in reducing the waste. Therefore, in this document, we also examine to correlation of recycling rate and global warming in a set of countries. 

## Summary Information
In the Country Level Dataset, we are able to access data regarding the different types of waste and amounts of those wastes for every country.
